...
![](/assets/images/YYYY-MM-DD-post-name/Blank-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/Layer1-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/Layer2-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/Layer3-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/Layer4-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/Layer5-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/Layer6-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/Layer7-1.png)<!-- -->
...
color related to intelligence? \#\#\# Linear mixed model with a
categorical predictor First we have to fit our `lmer` model. If you’re
still new to `emmeans`, it’s best to save the fitted model as an object
so that you can play around with different calls. At the end of the
section I’ll show you the fastest way to go from model -&gt; plot.
...
![](/assets/images/YYYY-MM-DD-post-name/plot%20model%20estimates-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/model%20estimates%20with%20jitter-1.png)<!-- -->
<br>
...
![](/assets/images/YYYY-MM-DD-post-name/violin%20plot-1.png)<!-- -->
<br>
...
![](/assets/images/YYYY-MM-DD-post-name/violin%20plot%20smaller%20bw-1.png)<!-- -->
<br>
...
![](/assets/images/YYYY-MM-DD-post-name/emmeans%20df%20interaction%20model-1.png)<!-- -->
...
```
    ...
    ## 1   Blue   201.3165 0.90382507 0.02538131 Inf 0.84133269 0.9433613
    ## 2    Red   201.3165 0.52268637 0.05438451 Inf 0.41667487 0.6266927
    ## 3 Yellow   201.3165 0.06267199 0.02399954 Inf 0.02914629 0.1296125
...
the same scale s the original variable, instead of being on the log-odds
scale. If you’re using only categorical predictors, then this is the
only `emmeans` modification you have to worry about.
...
![](/assets/images/YYYY-MM-DD-post-name/glmer%20emmeans%20range-1.png)<!-- -->
<br>
...
![](/assets/images/YYYY-MM-DD-post-name/glmer%20emmeans%20custom%20function-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/speedy%20plot-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/paletti-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/glmer%20plot-1.png)<!-- --> <br>
...
![](/assets/images/YYYY-MM-DD-post-name/scale%20x%20continuous-1.png)<!-- -->
<br>
...
![](/assets/images/YYYY-MM-DD-post-name/slanted%20x%20labels-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/pubr-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/pubr%20legend-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/patchwork-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/unnamed-chunk-2-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/unnamed-chunk-3-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/unnamed-chunk-4-1.png)<!-- -->
...
![](/assets/images/YYYY-MM-DD-post-name/unnamed-chunk-5-1.png)<!-- -->
