...
```
    ...
    ## 1 mu       1.64   1.64  0.0128  0.0126  1.62  1.66   1.00    3842.    2554.
    ## 2 sigma    0.639  0.639 0.00911 0.00886 0.624 0.654  1.00    3649.    2552.
...
```
    ...
    ##   variable  mean median      sd     mad    q5   q95  rhat ess_bulk ess_tail
    ##   <chr>    <dbl>  <dbl>   <dbl>   <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl>
    ## 1 theta    0.710  0.710 0.0145  0.0141  0.685 0.734  1.00    2314.    2485.
    ## 2 mu       1.51   1.51  0.0102  0.0103  1.49  1.52   1.00    2736.    2602.
    ## 3 sigma    0.345  0.344 0.00897 0.00923 0.330 0.359  1.00    2306.    2951.
...
y_inattentive, y_attentive, and with directed arrows from z_inattentive
to y_inattentive and from z_attentive to
z_inattentive](../assets/images/2022-02-21-hmms/mixture.png){:
.half-img }
...
```
    ...
    ##   variable      mean  median    sd   mad      q5   q95  rhat ess_bulk ess_tail
    ##   <chr>        <dbl>   <dbl> <dbl> <dbl>   <dbl> <dbl> <dbl>    <dbl>    <dbl>
    ## 1 theta[1,1]  0.495   0.496  0.293 0.386  0.0435 0.951  1.00    3883.    2282.
    ## 2 theta[2,1]  0.495   0.483  0.290 0.372  0.0443 0.950  1.00    3583.    2564.
    ## 3 theta[1,2]  0.505   0.504  0.293 0.386  0.0493 0.956  1.00    3883.    2282.
    ## 4 theta[2,2]  0.505   0.517  0.290 0.372  0.0500 0.956  1.00    3583.    2564.
    ## 5 pi[1]       0.496   0.492  0.240 0.249  0.0875 0.911  1.00    3617.    2684.
    ## 6 pi[2]       0.504   0.508  0.240 0.249  0.0885 0.913  1.00    3617.    2684.
    ## 7 mu         -0.0170 -0.0211 0.991 1.00  -1.64   1.61   1.00    3555.    2543.
    ## 8 sigma       0.796   0.668  0.607 0.595  0.0629 1.96   1.00    1854.    1239.
...
```
    ...
    ##   variable    mean median      sd     mad     q5   q95  rhat ess_bulk ess_tail
    ##   <chr>      <dbl>  <dbl>   <dbl>   <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
    ## 1 theta[1,1] 0.894  0.895 0.00732 0.00737 0.882  0.906  1.00    4357.    2857.
    ## 2 theta[2,1] 0.259  0.259 0.0163  0.0161  0.233  0.287  1.00    3958.    2946.
    ## 3 theta[1,2] 0.106  0.105 0.00732 0.00737 0.0938 0.118  1.00    4357.    2857.
    ## 4 theta[2,2] 0.741  0.741 0.0163  0.0161  0.713  0.767  1.00    3958.    2946.
    ## 5 pi[1]      0.711  0.711 0.0192  0.0196  0.679  0.741  1.00    4179.    3255.
    ## 6 pi[2]      0.289  0.289 0.0192  0.0196  0.259  0.321  1.00    4179.    3255.
    ## 7 mu         1.51   1.51  0.00793 0.00786 1.50   1.53   1.00    5533.    3286.
    ## 8 sigma      0.337  0.337 0.00581 0.00578 0.328  0.347  1.00    3757.    3020.
...
```
    ...
    ##   variable    mean median      sd     mad     q5   q95  rhat ess_bulk ess_tail
    ##   <chr>      <dbl>  <dbl>   <dbl>   <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
    ## 1 theta[1,1] 0.896  0.897 0.00980 0.00981 0.880  0.912  1.00    3301.    3131.
    ## 2 theta[2,1] 0.242  0.242 0.0223  0.0231  0.206  0.278  1.00    3298.    3023.
    ## 3 theta[1,2] 0.104  0.103 0.00980 0.00981 0.0881 0.120  1.00    3301.    3131.
    ## 4 theta[2,2] 0.758  0.758 0.0223  0.0231  0.722  0.794  1.00    3298.    3023.
    ## 5 pi[1]      0.700  0.700 0.0219  0.0216  0.663  0.735  1.00    5310.    3370.
    ## 6 pi[2]      0.300  0.300 0.0219  0.0216  0.265  0.337  1.00    5310.    3370.
    ## 7 mu         1.51   1.51  0.00930 0.00927 1.49   1.52   1.00    3848.    3144.
    ## 8 sigma      0.337  0.337 0.00746 0.00746 0.324  0.349  1.00    3263.    2869.
...
$$t$. But what we want is to get the most likely
\*sequence\* of latent states given the data, $$
p(z\_{1:t} \| y\_{1:t})$$. To do that, we’ll use the Viterbi algorithm.
...
```
    ...
    ##   variable    mean median      sd     mad     q5   q95  rhat ess_bulk ess_tail
    ##   <chr>      <dbl>  <dbl>   <dbl>   <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl>
    ## 1 theta[1,1] 0.896  0.896 0.00992 0.00983 0.879  0.912  1.00    3095.    2862.
    ## 2 theta[2,1] 0.242  0.242 0.0219  0.0227  0.207  0.279  1.00    3757.    2798.
    ## 3 theta[1,2] 0.104  0.104 0.00992 0.00983 0.0880 0.121  1.00    3095.    2862.
    ## 4 theta[2,2] 0.758  0.758 0.0219  0.0227  0.721  0.793  1.00    3757.    2798.
    ## 5 pi[1]      0.700  0.700 0.0222  0.0216  0.662  0.736  1.00    5664.    3317.
    ## 6 pi[2]      0.300  0.300 0.0222  0.0216  0.264  0.338  1.00    5664.    3371.
    ## 7 mu         1.51   1.51  0.00911 0.00932 1.49   1.52   1.00    3579.    2655.
    ## 8 sigma      0.337  0.336 0.00736 0.00725 0.325  0.349  1.00    3402.    2816.
...
supervised learning case! So, even if we haven’t perfectly recovered the
...
However, there’s always much more that can be done. Similar to
...
what direction you’re heading, hopefully this tutorial provided a good
foundation to start.
