...
author: allie
categories: [ tutorial ]
image: assets/images/2021-04-07-ggplot/ggplot.jpg
featured: false
hidden: false
output:
...
Welcome! This is an intermediate-level workshop about the R package `ggplot2`. We'll cover custom aesthetics, plotting model estimates, multi-layered plots, and advanced geoms. 
