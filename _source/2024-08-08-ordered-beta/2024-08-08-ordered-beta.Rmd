...
the idea is that this allows participants to make finer-grade
...
assumes some familiarity with `R` and introductory statistics, so now
is a good time to brush up on the basics, if necessary. In contrast,
...
All of these things might sound like overly-specific
